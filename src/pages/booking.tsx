...
import StepProgressBar, { type Step } from "../components/booking/StepProgressBar";
import ServiceSelectionPanel, { type ServiceOption } from "../components/booking/ServiceSelectionPanel";
...
const StethoscopeIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M4 4v5a4 4 0 008 0V4M8 19a3 3 0 100-6 3 3 0 000 6zM16 9v1a4 4 0 01-4 4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const WrenchIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M14.7 6.3a4 4 0 10-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 005.4-5.4l-2.2 2.2-2.8-2.8 2.2-2.2z" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const DropletIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M12 3s6 7 6 11a6 6 0 11-12 0c0-4 6-11 6-11z" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const CarIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M3 13l1.5-4.5A2 2 0 016.4 7h11.2a2 2 0 011.9 1.5L21 13M3 13v5a1 1 0 001 1h1a1 1 0 001-1v-1h12v1a1 1 0 001 1h1a1 1 0 001-1v-5M3 13h18" strokeLinecap="round" strokeLinejoin="round" />
...
const MapPinIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M12 21s7-7.2 7-12a7 7 0 10-14 0c0 4.8 7 12 7 12z" strokeLinecap="round" strokeLinejoin="round" />
...
const TagIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    <path d="M20.6 11.6L12.4 3.4A2 2 0 0011 3H4v7a2 2 0 00.6 1.4l8.2 8.2a2 2 0 002.8 0l5-5a2 2 0 000-2.8z" strokeLinecap="round" strokeLinejoin="round" />
...
const features: FeatureItemProps[] = [
  { icon: <ClockIcon />, title: "Quick Booking", description: "Book in less than 2 minutes." },
  { icon: <ShieldIcon />, title: "Expert Technicians", description: "Certified professionals you can trust." },
  { icon: <TagIcon />, title: "Upfront Pricing", description: "No hidden fees, ever." },
  { icon: <HeadsetIcon />, title: "Customer Support", description: "We're here to help you anytime." },
];

const BookingPage: React.FC = () => {
  const [currentStep, setCurrentStep] = useState<number>(1);
  const [selectedServiceId, setSelectedServiceId] = useState<string>("auto-diagnosis");
  ...
  const handleContinue = () => {
    ...
    // wire up navigation to step 2 (date & time) here later
  };
